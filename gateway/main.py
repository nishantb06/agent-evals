...
PORT = int(os.getenv("GATEWAY_PORT") or os.getenv("GATEWAY_V8_PORT", "8108"))
...
# long-context Gemini; HUGE is rejected (caller should summarise first).
TIER_TO_ORDER = {
        ...
        if router_decision.tier == "HUGE":
            raise HTTPException(
                503,
                {
                    ...
                    "hint": "Input too large for a single call — summarise or chunk first. "
