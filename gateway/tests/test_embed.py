"""Embed-endpoint tests. Run from gateway/:  uv run pytest -v tests/test_embed.py
...
they do NOT require the gateway to be running on a port. This keeps the
test suite fast (~5s for the four tests) and self-contained.
"""
