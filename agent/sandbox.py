...
poisoning the orchestrator's stdout — not a SECURITY boundary. For real
isolation, use Firejail or a container runtime.
...
def run_python(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="ollive-sandbox-") as cwd:
