...
# Sibling layout: agent/ and gateway/ under src/. Resolve the gateway dir
# relative to this file. Override with OLLIVE_GATEWAY_DIR if you move things.
import os as _os
GATEWAY_DIR = Path(
...
def ensure_gateway() -> None:
    ...
    if not GATEWAY_DIR.exists():
        raise RuntimeError(
            ...
            "Ensure src/gateway is present before running the agent."
        )
