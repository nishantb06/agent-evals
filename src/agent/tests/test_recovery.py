...
The classifier is keyword-based; without these tests a gateway-prose
change is a silent regression.

The strings below were captured from real httpx / FastAPI error
output in the gateway logs and from the providers.py error branches.
"""
